...
void loop() {
  ...
  case STATE_VOTING: {
    ...
    // Temporary deterministic selection until touchscreen integration is
    // wired to backend candidate IDs.
    delay(1000);
    String selectedCandidate = availableCandidates[candidateSelectionIndex];
    candidateSelectionIndex =
        (candidateSelectionIndex + 1) % availableCandidateCount;
