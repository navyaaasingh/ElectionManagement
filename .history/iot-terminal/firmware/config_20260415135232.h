...
#define MQTT_TOPIC_AUTH "election/auth/request"
#define MQTT_TOPIC_AUTH_RESPONSE_PREFIX "election/auth/response/"
#define MQTT_TOPIC_STATUS "election/terminal/status"
#define MQTT_TOPIC_VOTE_ACK_PREFIX "election/vote/ack/"
