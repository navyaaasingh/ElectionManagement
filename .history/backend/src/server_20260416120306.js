...
const disputeRoutes = require('./routes/dispute.routes.js');
const supervisorRoutes = require('./routes/supervisor.routes.js');
const verificationRoutes = require('./routes/verification.routes.js');
const ballotRoutes = require('./routes/ballot.routes.js');
const custodyRoutes = require('./routes/custody.routes.js');
const eligibilityRoutes = require('./routes/eligibility.routes.js');
...
app.use('/api/v1/ballots', ballotRoutes);
...
const startServer = async () => {
    try {
        ...
        try {
            ...
            console.log('📡 IoT MQTT service initialized');
        } catch (error) {
            console.warn('⚠️  IoT MQTT initialization failed. Terminal MQTT integration disabled.');
        }
