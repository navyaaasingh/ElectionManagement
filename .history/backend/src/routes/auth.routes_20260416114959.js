...
const { getPermissionsForAdminRole, getRoleClaimForAdminRole } = require('../modules/rbac/permissionMap.js');
...
const buildAdminToken = (admin) => {
    const roleClaim = getRoleClaimForAdminRole(admin.role);
    return generateToken({
        ...
        permissions: getPermissionsForAdminRole(admin.role),
    });
};
